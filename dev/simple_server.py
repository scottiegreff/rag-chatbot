...
def generate_mock_response(user_message: str) -> str:
    ...
    if "hello" in message_lower or "hi" in message_lower:
        return "Hello! I'm the AI Chatbot. How can I help you today?"
    
    elif "help" in message_lower:
        return "I can help you with:\n- Answering questions about documents\n- Searching through files\n- Providing information about procedures\n- General inquiries\n\nWhat would you like to know?"
    
    elif "policy" in message_lower:
        return "I can help you find information about policies. Could you be more specific about which policy you're looking for?"
        ...
        return "That's an interesting question! I'm currently running in demo mode, but I can help you with general information. For specific document searches, you'll need to upload relevant documents first."
    
    else:
        return "Thank you for your message. I'm the AI Chatbot and I'm here to help you with questions about policies, procedures, and documents. You can ask me questions or upload documents for me to analyze."

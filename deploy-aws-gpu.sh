...
# AWS GPU Deployment Script for FCI Chatbot
...
KEY_NAME=${KEY_NAME:-"fci-chatbot-key"}
SECURITY_GROUP_NAME=${SECURITY_GROUP_NAME:-"fci-chatbot-sg"}
VOLUME_SIZE=${VOLUME_SIZE:-"50"}  # GB

echo -e "${BLUE}🚀 AWS GPU Deployment Script for FCI Chatbot${NC}"
...
aws ec2 create-security-group \
    ...
    --description "Security group for FCI Chatbot" \
...
echo -e "  2. Download your model file to /opt/fci-chatbot/models/"
